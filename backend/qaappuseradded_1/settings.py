"""
Django settings for qaappuseradded_1 project.
...
ROOT_URLCONF = 'qaappuseradded_1.urls'
...
WSGI_APPLICATION = 'qaappuseradded_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "qaappuseradded_1 API",
    "DESCRIPTION": "API documentation for qaappuseradded_1 App",
    "VERSION": "v1",
}
